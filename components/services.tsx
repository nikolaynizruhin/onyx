...
const services: ServiceInterface[] = [
  ...
  },
  {
    ...
    description: "Забезпечення будівництва матеріально-технічними ресурсами. Аналіз поточного стану, прогноз результатів, звітність. Контроль якості та термінів роботи. Забезпечення дотримання технології зведення та монтажу. Мінімізування поточних ризиків.",
    icon: 'drawing',
    alt: 'Drawing',
  },
  {
